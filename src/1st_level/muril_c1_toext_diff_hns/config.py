...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-muril-c1-toext-diff-hns'
if is_kaggle:
    ...
    drive_name = 'Chaii'
    model_save = 'muril_c1_toext_diff_hns'
    
    TRAINING_FILE = f'/content/{repo_name}/data/train_folds_external_cleaned_dropped.csv'
    TEST_FILE = f'/content/{repo_name}/data/test.csv'
    SUB_FILE = f'/content/{repo_name}/data/sample_submission.csv'
    TRAINING_FILE_PICKLE = f'/content/gdrive/MyDrive/Dataset/{drive_name}/oof_prob/muril_c1_toext_diff.pkl'
    PRETRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/1st_level/muril_c1_toext_diff'
