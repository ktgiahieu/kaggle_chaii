...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-indicbert-c1-u-pretrained-ce'
if is_kaggle:
    ...
    drive_name = 'Chaii'
    model_save = 'indicbert_c1_u_pretrained_ce'
    
    TRAINING_FILE = f'/content/{repo_name}/data/train_folds_cleaned.csv'
    TEST_FILE = f'/content/{repo_name}/data/test.csv'
    SUB_FILE = f'/content/{repo_name}/data/sample_submission.csv'
    PRETRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/pretrained/indicbert_c1_external_ce/model.bin'
