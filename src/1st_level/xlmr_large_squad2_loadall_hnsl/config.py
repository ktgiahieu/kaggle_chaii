...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-xlmr-large-squad2-loadall-hnsl'
if is_kaggle:
    ...
    drive_name = 'Chaii'
    model_save = 'xlmr_large_squad2_loadall_hnsl'
    ...
    PRETRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/pretrained/xlmr_large_squad2_external/model.bin'
