...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-roberta-test-ta'
if is_kaggle:
    ...
    MODEL_CONFIG = '../input/roberta-transferred-to-hindi-tamil-with-wechsel/roberta-large-wechsel-tamil'
else: #colab
    repo_name = 'kaggle_chaii'
    drive_name = 'Chaii'
    model_save = 'roberta_test_ta'
