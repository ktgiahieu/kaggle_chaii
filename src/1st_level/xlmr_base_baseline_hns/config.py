...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-xlmr-base-baseline-hns'
if is_kaggle:
    ...
    drive_name = 'Chaii'
    model_save = 'xlmr_base_baseline_hns'
    
    TRAINING_FILE = f'/content/gdrive/MyDrive/Dataset/{drive_name}/xlmr_base_classifier.pkl'
