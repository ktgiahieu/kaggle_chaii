...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-7f-muril-ls2-5e6-c1-ext-diff'
if is_kaggle:
    ...
    drive_name = 'Chaii'
    model_save = '7f_muril_ls2_5e6_c1_ext_diff'
    
    TRAINING_FILE = f'/content/{repo_name}/data/external_dropped.csv'
    VALID_FILE = f'/content/{repo_name}/data/7f_train_folds_external_cleaned_dropped.csv'
