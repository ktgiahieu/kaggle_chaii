...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-rembert-c1-toext-diff'
if is_kaggle:
    ...
    MODEL_CONFIG = '../input/google-rembert-squad2'
else: #colab
    repo_name = 'kaggle_chaii'
    drive_name = 'Chaii'
    model_save = 'rembert_c1_toext_diff'
    ...
    MODEL_CONFIG = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/pretrained/google-rembert-squad2'
...
LEARNING_RATES_RANGE = [5e-6, 7e-6]
WEIGHT_DECAY = 0.01