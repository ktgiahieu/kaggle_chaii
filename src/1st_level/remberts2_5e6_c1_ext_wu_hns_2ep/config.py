...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-remberts2-5e6-c1-ext-wu-hns-2ep'
if is_kaggle:
    ...
    drive_name = 'Chaii'
    model_save = 'remberts2_5e6_c1_ext_wu_hns_2ep'
    
    TRAINING_FILE = f'/content/{repo_name}/data/train_folds_external_cleaned_dropped.csv'
    TEST_FILE = f'/content/{repo_name}/data/test.csv'
    SUB_FILE = f'/content/{repo_name}/data/sample_submission.csv'
    TRAINING_FILE_PICKLE = f'/content/gdrive/MyDrive/Dataset/{drive_name}/oof_prob/remberts2_5e6_c1_ext_wu.pkl'
    PRETRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/1st_level/remberts2_5e6_c1_ext_wu'
