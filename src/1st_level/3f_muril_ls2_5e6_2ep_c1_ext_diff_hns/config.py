...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-3f-muril-ls2-5e6-2ep-c1-ext-diff-hns'
if is_kaggle:
    ...
    drive_name = 'Chaii'
    model_save = '3f_muril_ls2_5e6_2ep_c1_ext_diff_hns'
    
    TRAINING_FILE = f'/content/{repo_name}/data/3f_train_folds_external_cleaned_dropped.csv'
    TEST_FILE = f'/content/{repo_name}/data/test.csv'
    SUB_FILE = f'/content/{repo_name}/data/sample_submission.csv'
    TRAINING_FILE_PICKLE = f'/content/gdrive/MyDrive/Dataset/{drive_name}/oof_prob/3f_muril_ls2_5e6_2ep_c1_ext_diff.pkl'
    PRETRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/1st_level/3f_muril_ls2_5e6_2ep_c1_ext_diff'
