...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-3f-xlmrls2-c1-toext-diff1-hns'
if is_kaggle:
    ...
    drive_name = 'Chaii'
    model_save = '3f_xlmrls2_c1_toext_diff1_hns'
    
    TRAINING_FILE = f'/content/{repo_name}/data/3f_train_folds_external_cleaned_dropped.csv'
    TEST_FILE = f'/content/{repo_name}/data/test.csv'
    SUB_FILE = f'/content/{repo_name}/data/sample_submission.csv'
    TRAINING_FILE_PICKLE = f'/content/gdrive/MyDrive/Dataset/{drive_name}/oof_prob/3f_xlmrls2_c1_toext_diff1.pkl'
    PRETRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/1st_level/3f_xlmrls2_c1_toext_diff1'
