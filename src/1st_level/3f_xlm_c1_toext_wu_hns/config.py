...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-3f-xlm-c1-toext-wu-hns'
if is_kaggle:
    ...
    MODEL_CONFIG = '../input/xlm-mlm-100-1280'
else: #colab
    repo_name = 'kaggle_chaii'
    drive_name = 'Chaii'
    model_save = '3f_xlm_c1_toext_wu_hns'
    
    TRAINING_FILE = f'/content/{repo_name}/data/train_folds_external_cleaned_dropped.csv'
    TEST_FILE = f'/content/{repo_name}/data/test.csv'
    SUB_FILE = f'/content/{repo_name}/data/sample_submission.csv'
    TRAINING_FILE_PICKLE = f'/content/gdrive/MyDrive/Dataset/{drive_name}/oof_prob/3f_xlm_c1_toext_wu.pkl'
    PRETRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/1st_level/3f_xlm_c1_toext_wu'
    MODEL_SAVE_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/1st_level/{model_save}'
    TRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/1st_level/{model_save}'
    INFERED_PICKLE_PATH = f'/content/{repo_name}/pickle'

    MODEL_CONFIG = 'xlm-mlm-100-1280'
...
N_LAST_HIDDEN = [8,  12,  4]
BERT_DROPOUT = 0.1
HIGH_DROPOUT = [0.3 , 0.45, 0.4 ]
SOFT_ALPHA = [1. , 0.6, 0.9]
WARMUP_RATIO = 0.1
