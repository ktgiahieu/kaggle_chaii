...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-7f-muril-ls2-5e6-c1-ext-diff-hns'
if is_kaggle:
    TRAINING_FILE = f'../input/{my_impl}/data/7f_train_folds_external_cleaned_dropped.csv'
    ...
    drive_name = 'Chaii'
    model_save = '7f_muril_ls2_5e6_c1_ext_diff_hns'
    
    TRAINING_FILE = f'/content/{repo_name}/data/7f_train_folds_external_cleaned_dropped.csv'
    TEST_FILE = f'/content/{repo_name}/data/test.csv'
    SUB_FILE = f'/content/{repo_name}/data/sample_submission.csv'
    TRAINING_FILE_PICKLE = f'/content/gdrive/MyDrive/Dataset/{drive_name}/oof_prob/7f_muril_ls2_5e6_c1_ext_diff.pkl'
    PRETRAINED_MODEL_PATH = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/1st_level/7f_muril_ls2_5e6_c1_ext_diff'
