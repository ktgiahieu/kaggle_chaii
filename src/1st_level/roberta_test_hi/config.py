...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-roberta-test-hi'
if is_kaggle:
    ...
    MODEL_CONFIG = '/content/gdrive/MyDrive/Dataset/Chaii/model_save/pretrained/roberta-large-wechsel-hindi'
