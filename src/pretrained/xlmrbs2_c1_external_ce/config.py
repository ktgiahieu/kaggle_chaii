...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-xlmrbs2-c1-external-ce'
if is_kaggle:
    TRAINING_FILE = f'../input/{my_impl}/data/external_dropped.csv'
    VALID_FILE = f'../input/{my_impl}/data/train_folds_cleaned_dropped.csv'
    ...
    drive_name = 'Chaii'
    model_save = 'xlmrbs2_c1_external_ce'
...
LEARNING_RATES_RANGE = [4e-5, 4e-5]
WEIGHT_DECAY = 0.01