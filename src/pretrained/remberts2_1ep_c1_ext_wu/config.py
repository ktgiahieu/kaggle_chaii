...
my_impl = 'chaii-impl'
my_model_dataset = 'chaii-remberts2-1ep-c1-ext-wu'
if is_kaggle:
    ...
    MODEL_CONFIG = '../input/google-rembert-squad2-1ep'
else: #colab
    repo_name = 'kaggle_chaii'
    drive_name = 'Chaii'
    model_save = 'remberts2_1ep_c1_ext_wu'
    ...
    MODEL_CONFIG = f'/content/gdrive/MyDrive/Dataset/{drive_name}/model_save/pretrained/google-rembert-squad2-1ep'
